    ...
    <table class="table table-striped">
        <thead>
            <tr>
                ...
                <th><a href="?page=list_st_prof&p=<?php echo $page; ?>&sort=name&dir=<?php echo $sort_direction == 'ASC' ? 'desc' : 'asc'; ?>">Nume</a></th>
                <th>Username</th>
                <th>Email</th>
            </tr>
        </thead>
        ...
        if (count($students) > 0) {
            ...
            echo "<tr><td colspan='4'>Nu există studenți în baza de date.</td></tr>";
        }
        ?>
        </tbody>
    </table>
