    ...
    <div class="container">
        ...
        <div class="columns">
            ...
            <div class="column box">
                ...
                <a href="secretar.php?page=list_st"         class="list-button"><i class="fas fa-list"></i> Listă studenți</a>
                ...
                <a href="secretar.php?page=view_doc"        class="view-button"><i class="fas fa-newspaper"></i> Dosare bursa</a>
